...
if __name__ == "__main__":
  ...
  duplicate_images_and_update_csv(dest_folder+"/test"+sub_dir+"/"+qa_name, dest_folder+"/test"+sub_dir)
  duplicate_images_and_update_csv(dest_folder+"/train"+sub_dir+"/"+qa_name, dest_folder+"/train"+sub_dir)
